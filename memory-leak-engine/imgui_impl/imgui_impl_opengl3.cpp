...
// In the rest of your app/memory-leak-engine, you can use another loader of your choice (gl3w, glew, glad, glbinding, glext, glLoadGen, etc.).
...
// This is in order to be able to run within an OpenGL memory-leak-engine that doesn't do so.
